...
using TimeContext = System.Tuple<MaximoParalelismo
    ...
    internal class Program
    {
        ...
        private static void Main()
        {
            ...
            if (testes_0n)
            {
                ...
                foreach (var test in tests)
                {
                    ...
                    foreach (var products in new[] { 2, 5, 8 }) //10, 50, 100, 500, 1000 })
                    {
        ...
        private static void Teste()
        {
            ...
            Func<int, AbstractEvent[], float> time = (prod, seq) => TimeEvaluation(
                ...
                plant.InitialState,
                plant.TargetState,
                seq.Where(e => e.IsControllable).ToArray(),
                plant.InitialScheduler,
                plant.UpdateFunction,
                plant.InitialRestrition(prod),
                transitions
        ...
        // Gu-Comment: Criação do teste para gerar a sequencia da Tatiana e testar com o contagem de tempo do lucas
        private static IEnumerable<AbstractEvent> Tatiana_Makespan(
            DFA g,
            AbstractState initial,
            AbstractState target,
            int depth,
            ...
            )
        {
            ...
            distance.Add(
                ...
                res,
                0f));
            return distance[target].Item1.Reverse();
    ...
    internal class SF : ISchedulingProblem
    {
        ...
        public SF()
        {
            ...
            s = new[] {
                ...
                new ExpandedState("F", 0, Marking.Unmarked)
            };
